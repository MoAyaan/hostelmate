  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        {h.distanceKm != null && (
          <p className="text-xs mt-0.5 font-bold" style={{ color: "var(--ink-soft)" }}>🚗 ~{h.distanceKm} km from campus</p>
        )}
        {h.rating && (
          <span
  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-12">
      <div className="relative overflow-hidden -mx-6 px-6 pb-2">
        ...
        <div className="relative">
          ...
          <p className="mt-2 animate-riseIn max-w-2xl" style={{ color: "var(--ink-soft)", animationDelay: ".08s" }}>
            Hotels, resorts and homestays in the Yelahanka/Jakkur area, near campus, for move-in day or visiting weekends — listed closest to farthest. Ratings are pulled from booking sites and change often, and vary a lot between platforms — tap through to confirm current details before booking.
          </p>
        </div>
      </div>
      ...
      <p className="mt-6 text-xs text-center" style={{ color: "var(--ink-soft)" }}>
        Distances are approximate driving distance from campus via OpenStreetMap routing, rounded to the nearest half-km. Ratings sourced from TripAdvisor, Justdial, Booking.com, MakeMyTrip, and Agoda listings — always double-check current details before booking. Not an endorsement of any property.
      </p>
    </div>
  );
}
